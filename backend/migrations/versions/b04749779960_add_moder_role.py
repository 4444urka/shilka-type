...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_words_is_active'), table_name='words')
    op.drop_index(op.f('ix_words_language'), table_name='words')
    op.drop_index(op.f('ix_words_language_active'), table_name='words')
    op.drop_table('words')
    op.drop_index(op.f('ix_sentences_id'), table_name='sentences')
    op.drop_index(op.f('ix_sentences_is_active'), table_name='sentences')
    op.drop_index(op.f('ix_sentences_language'), table_name='sentences')
    op.drop_index(op.f('ix_sentences_language_active'), table_name='sentences')
